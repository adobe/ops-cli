...
# install opswrapper v0.33 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/0.33/ops-0.33.tar.gz
...
```sh
docker run -it adobe/ops-cli:0.33 bash
```
