...
# install opswrapper v1.6 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/1.6/ops-1.6.tar.gz
...
```sh
docker run -it adobe/ops-cli:1.6 bash
```
