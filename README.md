...
# install opswrapper v1.2 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/1.2/ops-1.2.tar.gz
...
```sh
docker run -it adobe/ops-cli:1.2 bash
```
