...
# install opswrapper v0.34 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/0.34/ops-0.34.tar.gz
...
```sh
docker run -it adobe/ops-cli:0.34 bash
```
