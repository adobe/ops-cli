...
# install opswrapper v0.35 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/0.35/ops-0.35.tar.gz
...
```sh
docker run -it adobe/ops-cli:0.35 bash
```
