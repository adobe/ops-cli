...
# install opswrapper v1.1 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/1.1/ops-1.1.tar.gz
...
```sh
docker run -it adobe/ops-cli:1.1 bash
```
