...
# install opswrapper v1.5 stable release
pip2 install --upgrade https://github.com/adobe/ops-cli/releases/download/1.5/ops-1.5.tar.gz
...
```sh
docker run -it adobe/ops-cli:1.5 bash
```
